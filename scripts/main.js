...
//   outEl.innerHTML += `<h2>Name: <em>${agent.fullName}</em></h2>`;
//   outEl.innerHTML += `<h2>Company: <em>${agent.company}</em></h2>`;
//   outEl.innerHTML += `<h2>Phone Number: <em>${agent.phoneNumber}</em></h2>`;
//   outEl.innerHTML += "<hr/>";
// });
